...
import HeroImageMobile from "@/public/assets/fastsecure_mobile.svg";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-600 mt-4">
              Send money to your loved ones with smiles.
              <br /> Enjoy faster money transfer, which is secure and <br />
              reliable in all ways. Send smiles today with the <br />{" "}
              XpressRemit mobile app. Get on Playstore and Appstore
            </p>
            <a
              href="/download"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Read through our FAQs and if you can&apos;t find what
                you&apos;re looking for, our experts will be happy to answer
                your questions.
              </p>
              <Link href="/faq">
